function [ eval_res_tq,eval_res_tq1,eval_res,mean_mean_temp_mean,mean_mean_eval_res_tq,Results_Decisions ] = Bayes_processF( Data_Sets22,Label,Extra_Apps,Extra_Labels,best_params)
...
for c = 1 : length(Data_Sets22)
    for i = 1 : length(New_Labels)
    temp_mean(c,:)  =mean(eval_res{c}{1}([1:length(New_Labels)] ~= i,:));
