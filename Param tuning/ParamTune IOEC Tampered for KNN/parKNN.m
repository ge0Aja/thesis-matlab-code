function [ finalacc,finaltpr,finalfpr,finalf1] = parKNN( Traindata,subspaceDimension,learnersnum,neighborKNN,indic,itr,Useriter)
%UNTITLED7 Summary of this function goes here
%   Detailed explanation goes here
parfor i=1:3
testind = (indic == i);
    trainind = ~testind;
    KnnSub =  trainClassifierKNN(Traindata(trainind,:),subspaceDimension,learnersnum,neighborKNN);
