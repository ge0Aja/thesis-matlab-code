...
%      fprintf('finished for gaussian For %d Settings\n',i);
    %%
    QuadResults{i} = parSVMQuadtest( DataSet,polyorder,Quadbox,i);
...
%      fprintf('finished for Quad For %d Settings\n',i);
    %%
    KNNResults{i} = parKnntest( DataSet,KnnPredict,Knnlearner,i);
...
%      fprintf('finished for KNN For %d Settings\n',i);
    %%
    RandForestResults{i} = parRandForesttest( DataSet,Forestlearner,ForestPredict,Forestleaf,i);
