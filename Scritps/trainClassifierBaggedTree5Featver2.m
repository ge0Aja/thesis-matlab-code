function [trainedClassifier, resubstitutionAccuracy] = trainClassifierBaggedTree5Featver2(datasetTable)
...
predictors = predictors(:,[false false false true true false false false false false false true false false false true false false false false false false false true false false false false]);
% Train a classifier
trainedClassifier = fitensemble(predictors, response, 'Bag', 200, 'Tree', 'Type', 'Classification', 'PredictorNames', {'column_4' 'column_5' 'column_12' 'column_16' 'column_24'}, 'ResponseName', 'column_29', 'ClassNames', [1 2 3 4 5 6]);
