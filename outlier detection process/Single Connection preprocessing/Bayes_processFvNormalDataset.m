function [ eval_res_tq,eval_res_tq1,eval_res,mean_mean_temp_mean,mean_mean_eval_res_tq,Results_Decisions ] = Bayes_processFvSingleUser( data,Label,best_params)
...
[ group_vote_counts_test,new_test_data,mean_mean_acc,mean_std_acc ,yfit_unknown_test,yfit_known_test,~,~,~] = Bayes_process_inner_single_user(data,Label,best_params.prct,best_params.learners,best_params.predictors,best_params.min_leaf);
